...
{
    /// <summary>
    /// Interaction logic for SPMSUN_MegaStockist.xaml
    /// </summary>
    public partial class SPMSUN_MegaStockist : UserControl
    {
        public SPMSUN_MegaStockist()
        {
            InitializeComponent();
        }
        ...
        MegaStockistModel viewMegaStockist;
        ...
        private List<PaymentHistoryModel> getPaymentHistory()
        {
            ...
            parameters = new List<string>();
            parameters.Add(viewMegaStockist.ID);
